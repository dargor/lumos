...
mod tests {
    ...
    fn test_classify_color() {
        assert_eq!(classify_color((0, 0, 0)), "dark");
        assert_eq!(classify_color((255, 255, 255)), "light");
        assert_eq!(classify_color((128, 128, 128)), "dark"); // Mid-gray is below threshold
        assert_eq!(classify_color((200, 200, 200)), "light");
        assert_eq!(classify_color((50, 50, 50)), "dark");
    }
}
